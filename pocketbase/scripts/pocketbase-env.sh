...
export POCKETBASE_DATA_DIR="${POCKETBASE_WORKDIR}/data"
export POCKETBASE_MIGRATION_DIR="${POCKETBASE_WORKDIR}/migrations"
export POCKETBASE_PUBLIC_DIR="${POCKETBASE_WORKDIR}/public"
